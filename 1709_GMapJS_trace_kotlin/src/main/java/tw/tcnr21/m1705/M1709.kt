...
class M1709: AppCompatActivity(), LocationListener {
    ...
    var sLocation: Array<String> = TODO()
    var Navon = "off"
    ...
    //-----------------------------------------------------------
    private var aton = "0,0"
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.m1709)
    ...
    private fun setMapLocation() {
        ...
        if (Navon === "on" && iSelect != 0) {
            ...
            webView!!.addJavascriptInterface(this@M1709, "AndroidFunction")
...
//定位改變時
        ...
        val centerURL = "javascript:centerAt(" + location.latitude + "," + location.longitude + ")"
    ...
    override fun onStatusChanged(provider: String, status: Int, extras: Bundle) {
        when (status) {
            ...
            LocationProvider.TEMPORARILY_UNAVAILABLE -> Log.v(TAG, "Status Changed: Temporarily Unavailable")
            ...
            REQUEST_CODE_ASK_PERMISSIONS -> {
                ...
                while (i < permissions.size) {
                    if (grantResults[i] == PackageManager.PERMISSION_GRANTED) {
                        Toast.makeText(applicationContext, permissions[i] + "權限申請成功!", Toast.LENGTH_LONG).show()
                    } else {
                        Toast.makeText(applicationContext, "權限被拒絕： " + permissions[i], Toast.LENGTH_LONG).show()
                    }
                    i++
                }
            }
    ...
    companion object {
        private val locations = arrayOf(arrayOf("我的位置", "0,0"), arrayOf("中區職訓", "24.172127,120.610313"), arrayOf("東海大學路思義教堂", "24.179051,120.600610"), arrayOf("台中公園湖心亭", "24.144671,120.683981"), arrayOf("秋紅谷", "24.1674900,120.6398902"), arrayOf("台中火車站", "24.136829,120.685011"), arrayOf("國立科學博物館", "24.1579361,120.6659828"))
